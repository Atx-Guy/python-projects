...
set_target_properties(libjpeg-turbo::jpeg PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/ryan/python-projects/convert-it/my-conda-env/lib/libjpeg.so.8.3.2"
  IMPORTED_SONAME_RELEASE "libjpeg.so.8"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::jpeg )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::jpeg "/home/ryan/python-projects/convert-it/my-conda-env/lib/libjpeg.so.8.3.2" )
...
set_target_properties(libjpeg-turbo::turbojpeg PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/ryan/python-projects/convert-it/my-conda-env/lib/libturbojpeg.so.0.3.0"
  IMPORTED_SONAME_RELEASE "libturbojpeg.so.0"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::turbojpeg )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::turbojpeg "/home/ryan/python-projects/convert-it/my-conda-env/lib/libturbojpeg.so.0.3.0" )
...
set_target_properties(libjpeg-turbo::turbojpeg-static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/ryan/python-projects/convert-it/my-conda-env/lib/libturbojpeg.a"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::turbojpeg-static )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::turbojpeg-static "/home/ryan/python-projects/convert-it/my-conda-env/lib/libturbojpeg.a" )
...
set_target_properties(libjpeg-turbo::jpeg-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "ASM_NASM;C"
  IMPORTED_LOCATION_RELEASE "/home/ryan/python-projects/convert-it/my-conda-env/lib/libjpeg.a"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo::jpeg-static )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo::jpeg-static "/home/ryan/python-projects/convert-it/my-conda-env/lib/libjpeg.a" )
